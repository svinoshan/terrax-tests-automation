...
import { FarmerProfileTestData } from '@data/farmer/farmer-profile.data';
...
export class FarmerProfilePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.nameWithInitialsInput = page.locator('[formcontrolname="nameWtInitials"]');
    ...
    this.contactPersonPhoneInput = page.locator('[formcontrolname="contactPersonTp"]');
    ...
    this.farmerCodeEUJASInput = page.locator('[formcontrolname="farmerCodeEUJAS"]');
    ...
    this.saveButton = page.locator('button').filter({ hasText: /save/i }).first();
    this.backButton = page.locator('button').filter({ hasText: /back/i }).first();
  }
  ...
  async selectMatOption(selectControl: Locator, optionName: string): Promise<void> {
